...
const CCP_FILE    = 'connection-bankb.json';
const MSP_ID      = 'BankBMSP';
const WALLET      = 'wallet-BankB';
const ADMIN_ID    = 'admin';
const USER_ID     = 'user1';                // change if needed
const AFFILIATION = 'bankb.department1';    // remove if not using affiliations
